...
mpirun -n 4 pakman rejection standard-simulator-accept-no-error.rej 10 \
    1> rejection.out 2> rejection.err
...
mpirun -n 4 pakman rejection standard-simulator-reject-no-error.rej 10 \
    1> rejection.out 2> rejection.err &
...
mpirun -n 4 pakman rejection standard-simulator-accept-error.rej 10 \
    1> rejection.out 2> rejection.err
...
mpirun -n 4 pakman rejection standard-simulator-reject-error.rej 10 \
    1> rejection.out 2> rejection.err && test_failed
