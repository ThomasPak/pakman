...
mpirun -n 4 pakman smc standard-simulator-accept-no-error.smc 10 \
    1> smc.out 2> smc.err
...
mpirun -n 4 pakman smc standard-simulator-reject-no-error.smc 10 \
    1> smc.out 2> smc.err &
...
mpirun -n 4 pakman smc standard-simulator-accept-error.smc 10 \
    1> smc.out 2> smc.err
...
mpirun -n 4 pakman smc standard-simulator-reject-error.smc 10 \
    1> smc.out 2> smc.err && test_failed
