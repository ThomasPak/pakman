...
# Exit without error
mpirun -n 4 pakman sweep persistent-mpi-simulator-no-error.sweep \
    --mpi-simulation --persistent 1> sweep.out 2> sweep.err
...
mpirun -n 4 pakman sweep persistent-mpi-simulator-error.sweep \
    --mpi-simulation --persistent 1> sweep.out 2> sweep.err
