...
mpirun -n 4 pakman rejection mpi-simulator-accept-no-error.rej 10 \
    --mpi-simulation 1> rejection.out 2> rejection.err
...
mpirun -n 4 pakman rejection mpi-simulator-reject-no-error.rej 10 \
    --mpi-simulation 1> rejection.out 2> rejection.err &
...
mpirun -n 4 pakman rejection mpi-simulator-accept-error.rej 10 \
    --mpi-simulation 1> rejection.out 2> rejection.err
...
mpirun -n 4 pakman rejection mpi-simulator-reject-error.rej 10 \
    --mpi-simulation 1> rejection.out 2> rejection.err && test_failed
