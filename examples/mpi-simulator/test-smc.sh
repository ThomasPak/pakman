...
mpirun -n 4 pakman smc mpi-simulator-accept-no-error.smc 10 \
    --mpi-simulation 1> smc.out 2> smc.err
...
mpirun -n 4 pakman smc mpi-simulator-reject-no-error.smc 10 \
    --mpi-simulation 1> smc.out 2> smc.err &
...
mpirun -n 4 pakman smc mpi-simulator-accept-error.smc 10 \
    --mpi-simulation 1> smc.out 2> smc.err
...
mpirun -n 4 pakman smc mpi-simulator-reject-error.smc 10 \
    --mpi-simulation 1> smc.out 2> smc.err && test_failed
